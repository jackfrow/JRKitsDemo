...
static CGFloat const kDefalultTextInset = 15.0;

@implementation DSToast

+ (instancetype)toastWithText:(NSString *)text
{
    return [[self alloc] initWithText:text animationType:DSToastAnimationTypeAlpha];
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        self.textInsets = UIEdgeInsetsMake(kDefalultTextInset, kDefalultTextInset+20, kDefalultTextInset, kDefalultTextInset+20);
...
- (void)show
{
    [self showInView:[self currentWindow] showType:DSToastShowTypeCenter];
}
